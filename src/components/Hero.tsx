...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-secondary/10 px-4 py-16 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-blue-500/10 rounded-full blur-2xl animate-float" style={{ animationDelay: '1s' }}></div>
      
      {/* Urgency Banner */}
      <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-red-500 to-orange-500 text-white py-3 px-4 text-center text-sm font-medium animate-pulse z-10 shadow-lg">
        🔥 PROMO AKHIR TAHUN! Diskon hingga 30% + Domain .com GRATIS! Hanya tersisa 5 slot bulan ini! ⏰
      </div>
