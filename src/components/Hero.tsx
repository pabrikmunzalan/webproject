        ...
        <div className="text-center space-y-8 animate-fade-up">
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 md:-right-8">
                <div className="bg-success text-success-foreground px-3 py-1 rounded-full text-xs md:text-sm font-semibold animate-float shadow-glow">
                  ✅ #1 Web Developer
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto animate-fade-up" style={{
            ...
            <div className="relative group flex flex-col items-center space-y-4 p-8 rounded-2xl glass shadow-elegant hover:shadow-glow transition-all duration-500 hover:scale-105">
              ...
              <div className="relative text-center space-y-2">
                ...
                <div className="flex justify-center space-x-1 mt-3">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="w-1 h-1 bg-primary/50 rounded-full animate-pulse" style={{ animationDelay: `${i * 0.1}s` }}></div>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="relative group flex flex-col items-center space-y-4 p-8 rounded-2xl glass shadow-elegant hover:shadow-glow transition-all duration-500 hover:scale-105">
              ...
              <div className="relative text-center space-y-2">
                ...
                <div className="flex justify-center space-x-1 mt-3">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="w-1 h-1 bg-success/50 rounded-full animate-pulse" style={{ animationDelay: `${i * 0.1}s` }}></div>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="relative group flex flex-col items-center space-y-4 p-8 rounded-2xl glass shadow-elegant hover:shadow-glow transition-all duration-500 hover:scale-105">
              ...
              <div className="relative text-center space-y-2">
                ...
                <div className="flex justify-center space-x-1 mt-3">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="w-1 h-1 bg-blue-500/50 rounded-full animate-pulse" style={{ animationDelay: `${i * 0.1}s` }}></div>
                  ))}
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8 animate-fade-up" style={{
            ...
            <div className="relative group">
              <Button 
                size="lg" 
                className="relative bg-gradient-to-r from-primary via-primary-glow to-blue-600 hover:from-primary/90 hover:via-primary-glow/90 hover:to-blue-600/90 text-primary-foreground px-10 py-8 text-lg font-bold shadow-glow hover:shadow-2xl transition-all duration-500 hover:scale-105 rounded-2xl overflow-hidden" 
            ...
            <Button 
              variant="outline"
              size="lg"
              className="px-10 py-8 text-lg font-semibold border-primary/30 hover:border-primary/60 hover:bg-primary/10 glass rounded-2xl group transition-all duration-300 hover:scale-105"
              onClick={handleVideoPlay}
            >
